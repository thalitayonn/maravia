...
<div class="admin-page space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <form method="GET" action="{{ route('admin.testimonials.index') }}" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="group">
                            ...
                            <select name="spam" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent">
                        ...
                        <div class="group">
                            ...
                            <select name="sort" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('admin.testimonials.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-3 rounded-lg font-semibold">
        ...
        <!-- Bulk Actions -->
        <div class="bg-white border border-gray-200 rounded-2xl mb-8" id="bulk-actions" style="display: none;">
            <div class="p-6">
                        ...
                        <div class="relative bg-white rounded-2xl p-6 border border-gray-200 hover:border-gray-300 transition">
                            <div class="flex items-start space-x-4">
                                ...
                                <input type="checkbox" name="testimonial_ids[]" value="{{ $testimonial->id }}" 
                                       class="testimonial-checkbox w-5 h-5 text-gray-700 bg-white border-gray-300 rounded focus:ring-gray-300 mt-2">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-gray-600 text-sm mb-3 bg-gray-100 px-3 py-1 rounded-lg inline-flex items-center">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-4 text-sm text-gray-500">
                                            <span class="bg-gray-100 text-gray-600 px-3 py-1 rounded-lg font-medium">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <button onclick="deleteTestimonial({{ $testimonial->id }})" 
                                                    class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm font-semibold shadow-sm">
        ...
        @else
            <div class="text-center py-16">
                <div class="bg-gray-100 rounded-full w-32 h-32 flex items-center justify-center mx-auto mb-6">
                    <i class="fas fa-quote-left text-6xl text-gray-400"></i>
                </div>
