...
<section class="py-12 bg-gradient-to-br from-blue-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <div class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-100 text-blue-600 text-3xl mb-4">
                <i class="fas fa-tag"></i>
            </div>
            <h1 class="text-4xl font-bold text-gray-900 mb-4">#{{ $tag->name }}</h1>
            @if($tag->description)
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">{{ $tag->description }}</p>
            @endif
            <p class="text-gray-500 mt-4">{{ $photos->total() }} foto dengan tag ini</p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="text-xl text-gray-500">Belum ada foto dengan tag ini</p>
            </div>
        @endif
    </div>
</section>
